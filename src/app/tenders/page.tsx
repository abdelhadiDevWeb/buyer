...
export default function TendersPage() {
  ...
  const fetchTenders = async () => {
    try {
      ...
      const tendersData = (response as any)?.data ?? response;
        ...
        <div className="container">
          ...
          <div className="page-header">
            ...
            <p style={{ margin: 0, fontSize: '18px', opacity: 0.9 }}>
              Découvrez et participez aux appels d'offres en cours.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            {`${filteredTenders.length} appel(s) d'offres trouvé(s)`}
          </div>
          ...
          {filteredTenders.length === 0 ? (
            ...
            <div className="tenders-grid">
              {filteredTenders.map((tender) => {
                ...
                const isExpired = tender.status !== TENDER_STATUS.OPEN || timeRemaining === 'Terminé';
                  ...
                  >
                      ...
                      <div style={{ flex: 1 }}>
                        <div>
                          <span className={`badge ${tender.status === TENDER_STATUS.OPEN ? 'badge-success' : 'badge-danger'}`}>
                            {tender.status === TENDER_STATUS.OPEN ? 'Ouvert' : 'Fermé'}
                          </span>
                    ...
                    <div className="tender-stats">
                      ...
                      <div className="stat-item">
                        ...
                        <div className="stat-label">Meilleure offre</div>
                      </div>
                    </div>
                    ...
                    <div className="tender-footer">
                      <div className="tender-meta">
                        ...
                        <div className="tender-date">
                          Jusqu'au {formatDate(tender.endingAt)}
                        </div>
                      </div>
