  ...
  const handleSubmit = async () => {
    try {
      ...
      if (user) {
        ...
        if (user.isBanned) {
          setSnackbarMessage("Votre compte a été banni. Vous ne pouvez pas vous connecter.");
        ...
        throw new Error("Format de réponse invalide - aucun utilisateur trouvé dans la réponse");
      }
    } catch (error) {
